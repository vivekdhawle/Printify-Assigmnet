...
function ProductCard({img1Path,img2Path,description,by,prize,printifyPremium=" ",size}){
    ...
    return <>
        <div className="flex relative flex-col  min-w-72 flex-nowrap  flex-shrink-0 basis-1/4    " onMouseEnter={()=>setDisplay(false)} onMouseLeave={()=>setDisplay(true)} >
            ...
            <img
                    ...
                    className={`w-full h-auto transition-transform duration-100 ease-in-out transform ${display?"scale-100":"scale-110"}`}
                />
